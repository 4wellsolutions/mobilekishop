  ...
  <div class="admin-page-header">
    <div>
      ...
      <div class="breadcrumb-nav"><a href="{{ route('dashboard.index') }}">Dashboard</a><span class="separator">/</span><a
          href="{{ route('dashboard.pages.index') }}">Pages</a><span class="separator">/</span>Create</div>
    </div>
  </div>
      ...
      <form action="{{ route('dashboard.pages.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="admin-form-grid">
          ...
          <div class="admin-form-group"><label class="admin-form-label">Description</label>
            <input type="text" name="description" class="admin-form-control" value="{{ old('description') }}" required>
          </div>
          <div class="admin-form-group"><label class="admin-form-label">Canonical</label>
            <input type="text" name="canonical" class="admin-form-control" value="{{ old('canonical') }}" required>
          </div>
          <div class="admin-form-group"><label class="admin-form-label">Slug</label>
            <input type="text" name="slug" class="admin-form-control" value="{{ old('slug') }}" required>
          </div>
          <div class="admin-form-group"><label class="admin-form-label">H1</label>
            <input type="text" name="h1" class="admin-form-control" value="{{ old('h1') }}" required>
          </div>
