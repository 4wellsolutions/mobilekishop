...
@section('content')
  <div class="admin-page-header">
    <div>
      ...
      <div class="breadcrumb-nav"><a href="{{ route('dashboard.index') }}">Dashboard</a><span class="separator">/</span><a
          href="{{ route('dashboard.variants.index') }}">Variants</a><span class="separator">/</span>Edit</div>
    </div>
  </div>
  ...
  <div class="admin-card">
    ...
    <div class="admin-card-body">
      <form method="post" action="{{ route('dashboard.variants.update', $variant->id) }}" enctype="multipart/form-data">
        @csrf
        <div class="admin-form-group" style="max-width:400px;">
          <label class="admin-form-label">Name</label>
          <input type="text" name="variant_name" class="admin-form-control"
