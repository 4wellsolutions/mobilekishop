...
<div class="page-wrapper">
          ...
          <div class="col-12 col-md-3 col-lg-3">
            <div class="form-group">
              ...
              <select class="form-control" name="date_filter" id="date_filter">
                ...
                <option value="created_at" {{\Request::get('date_filter') == "created_at" ? "selected" : ''}}>Created By
                </option>
                <option value="updated_at" {{\Request::get('date_filter') == "updated_at" ? "selected" : ''}}>Updated By
                </option>
              </select>
            </div>
          </div>
          <div class="col-12 col-md-3 col-lg-3">
            <div class="form-group">
              ...
              <input type="date" name="date1" class="form-control"
                value="{{\Request::has('date1') ? \Request::get('date1') : \Carbon\Carbon::now()->format('Y-m-d')}}">
            </div>
          </div>
          <div class="col-12 col-md-3 col-lg-3">
            <div class="form-group">
              ...
              <input type="date" name="date2" class="form-control"
                value="{{\Request::has('date2') ? \Request::get('date2') : \Carbon\Carbon::now()->format('Y-m-d')}}">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-12 col-md-4 col-lg-4">
              ...
              <select class="form-control" name="filter_key" id="filter_key">
                ...
                <option value="release_date" {{\Request::get('filter_key') == "release_date" ? "selected" : ''}}>Release
                  Date</option>
                <option value="created_at" {{\Request::get('filter_key') == "created_at" ? "selected" : ''}}>Created By
                </option>
                <option value="updated_at" {{\Request::get('filter_key') == "updated_at" ? "selected" : ''}}>Updated By
                </option>
              </select>
            </div>
  ...
  <div class="">
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Total Mobiles: {{App\Mobile::count()}}, Mobiles Found: {{$total}}, Today:
          ({{isset($today) ? $today : 0}})</h5>
        <div class="table-responsive">
              ...
              @foreach($mobiles as $mobile)
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="{{route('dashboard.mobile.edit', $mobile->id)}}"><i
                          class="far fa-edit text-success fa-2x"></i></a> <a
                        href="{{route('mobile.show', ['brand' => $mobile->brand->slug, 'slug' => $mobile->slug])}}"
                        target="_blank"><i class="fas fa-eye fa-2x text-warning"></i></a></td>
                  </tr>
                </tbody>
              @endforeach
            @endif
          ...
          {{$mobiles->withQueryString()->links('pagination::bootstrap-5')}}
        </div>
      </div>
    </div>
  </div>
