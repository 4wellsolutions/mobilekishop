        ...
        <div class="container my-5 shadow-sm p-4 bg-white rounded-3 text-center">
            ...
            <div class="content fs-16 text-muted lh-lg mx-auto" style="max-width: 800px;">
                ...
                <div class="row mt-5 text-start">
                    ...
                    <div class="col-md-6 mb-4">
                        <h4 class="fw-bold text-dark"><i class="bi bi-arrows-angle-contract text-primary"></i> Dynamic
                            Comparison</h4>
                        <p>Our powerful comparison engine lets you pit up to three devices against each other to see exactly
                            how they stack up.</p>
                    </div>
                    <div class="col-md-6 mb-4">
                        <h4 class="fw-bold text-dark"><i class="bi bi-shield-check-fill text-primary"></i> User Insights
                        </h4>
                ...
                <p class="mt-5">Since our inception, MKS has grown from a local price-tracking tool to a global mobile
