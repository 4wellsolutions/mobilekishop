...
<style type="text/css">
    ...
    h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6 , .nav-item a{
        line-height: 1.1;
        font-family: Poppins,sans-serif;
    }
    body{
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="my-1" style="font-size: 12px;">
                <ol class="breadcrumb mb-1">
                    ...
                    <!-- Category -->
                    <li class="breadcrumb-item">
                        <a href="{{ url('/category/'.$product->category->slug) }}" class="text-decoration-none text-secondary">
                            {{ $product->category->category_name }}
                        </a>
                    </li>
                    <!-- Brand -->
                    <li class="breadcrumb-item">
                        <a href="{{ url('/brand/'.$product->brand->slug.'/'.$product->category->slug) }}" class="text-decoration-none text-secondary">
                            {{ $product->brand->name }}
                        </a>
                    </li>
                    <!-- Product -->
            ...
            <div class="col-12 col-md-9">
                ...
                <div class="row mb-2 d-flex justify-content-center">
                    <div class="col-5 col-md-6 d-flex justify-content-center align-items-center">
                        <a href="#images">
                            <img src="{{URL::to('/images/thumbnail.png')}}" data-echo="{{$product->thumbnail}}" class="mobile_image rounded mb-2" alt="{{$product->slug}}">
                        </a>
                        <div class="d-flex justify-content-center d-none">
                            <img id="shareIcon" src="{{URL::to('images/icons/share.png')}}" class="img-fluid mx-2" width="30" height="30" title="share">
                            <img id="heartIcon" src="{{URL::to('images/icons/heart.png')}}" class="img-fluid mx-2" width="30" height="30" title="heart">
                        </div>
                    </div>
                            ...
                            <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0" cellpadding="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-50"><a href="{{route('brand.show',[$product->brand->slug,$product->category->slug])}}" class="text-decoration-none fw-bold">{{($product->brand->name)}}</a></td>
                                    </tr>  
                                    <tr>
                                    ...
                                    <tr>
                                        <th class="w-50">Connector Type</th>
                                        <td class="w-50">{!! $connector_type !!}</td>
                                    </tr>
                                    <tr>
                                        <th class="w-50">Battery Capacity</th>
                                        <td class="w-50">{!! $battery_capacity !!}</td>
                                    </tr>
                                    <tr>
                                        <th class="w-50">Special Feature</th>
                                        <td class="w-50">{!! $special_feature !!}</td>
                                    </tr>
                                </tbody>
                            </table>
