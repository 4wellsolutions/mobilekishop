...
<main class="main container-lg">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
                ...
                <div class="col-5 col-md-6 d-flex justify-content-center align-items-center">
                    <a href="#images">
                        <img src="{{URL::to('/images/thumbnail.png')}}" data-echo="{{$product->thumbnail}}"
                            class="mobile_image rounded mb-2" alt="{{$product->slug}}">
                    </a>
                    ...
                    <div class="mb-2 mb-md-4 row">
                        <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="w-50">Watts</th>
                                    <td class="w-50">{{$watts}}</td>
                                </tr>
                                <tr>
                                    <th class="w-50">Input Voltage</th>
                                    <td class="w-50">{!! $input_voltage !!}</td>
                                </tr>
                                <tr>
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="mt-2">Specification:</h2>
                    <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                        cellpadding="0">
                        <tbody>
                            <tr>
                                <th class="w-50">Compatible Mobile Models</th>
                                <td class="w-50">{!! $compatible_mobile_models !!}</td>
                            </tr>
                            <tr>
                                <th class="w-50">Compatible Devices</th>
                                <td class="w-50">{!! $compatible_devices !!}</td>
                            </tr>
                            <tr>
                                <th class="w-50">Mounting Type</th>
                                <td class="w-50">{!! $mounting_type !!}</td>
                            </tr>
                            <tr>
                                <th class="w-50">Included Components</th>
                                <td class="w-50">{!! $included_components !!}</td>
                            </tr>
                            <tr>
                                <th class="w-50">Connectivity Technology</th>
                                <td class="w-50">{!! $connectivity_technology !!}</td>
                            </tr>
                        </tbody>
                    </table>
                    <h3>Description</h3>
