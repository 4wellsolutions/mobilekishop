...
@php
    ...
    $cable_type = $attributes->get('cable_type')->pivot->value ?? null;
    ...
    $max_wattage = $attributes->get('max_wattage')->pivot->value ?? null;
    $length = $attributes->get('length')->pivot->value ?? null;
                    ...
                    <div class="mb-2 mb-md-4 row">
                        <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="w-50">Cable Type</th>
                                    <td class="w-50">{!! $cable_type !!}</td>
                                </tr>
                                <tr>
                                    <th class="w-50">Max Wattage</th>
                                    <td class="w-50">{!! $max_wattage !!}</td>
                                </tr>
                                <tr>
                                    <th class="w-50">Length</th>
                                    <td class="w-50">{!! $length !!}</td>
                                </tr>
                                <tr>
    ...
    <script type="application/ld+json">
            {
                ...
                "description": "Get all the specifications, features, reviews, comparison, and price of {{Str::title($product->name)}} on the mobilekishop.net in {$country->country_name}.",
                "sku": "{{$product->id}}",
                "mpn": "{{$product->id}}",
