...
@section('content')
    ...
    <div class="flex flex-wrap items-center gap-2 text-sm mb-8">
        ...
        <a href="{{ url('/blogs') }}" class="text-text-muted hover:text-primary font-medium hover:underline">Blog</a>
        @if($blog->category)
            <span class="text-text-muted">/</span>
            <a href="{{ url('/blogs/category/' . $blog->category->slug) }}" class="text-text-muted hover:text-primary font-medium hover:underline">{{ $blog->category->name }}</a>
        @endif
        <span class="text-text-muted">/</span>
        ...
        <article class="lg:col-span-8">
            ...
            <div class="flex items-center justify-between mt-8 pt-6 border-t border-border-light">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="https://wa.me/?text={{ urlencode($blog->title . ' ' . url('/blogs/' . $blog->slug)) }}"
                       target="_blank" rel="noopener"
