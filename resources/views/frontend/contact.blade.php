            ...
            <div class="col-12 col-md-9">
                <div class="row">
                    ...
                    <form action="{{route('contact.post')}}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="message" id="message" class="form-control" placeholder="Message" style="height: 150px;" required>{{old('message')}}</textarea>
                ...
                <div class="row">
                    <p>For more details or any queries, please don’t hesitate to contact us on WhatsApp. <a class="" href="https://wa.me/message/ZEKV4JT3A4LDK1"><img src="{{URL::to('/images/icons/whatsapp.png')}}" alt="WhatsApp"></a></p>
                </div>
            </div>
