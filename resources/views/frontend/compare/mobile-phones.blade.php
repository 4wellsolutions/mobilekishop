        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container my-1" style="font-size: 12px;">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a class="text-decoration-none text-secondary" href="{{URL::To('/comparison')}}">Compares</a></li>
                    <li class="breadcrumb-item text-secondary active" aria-current="page">{{ $product->name }}
                    @if($product1) VS {{ $product1->name }} @endif
                    @if($product2) VS {{ $product2->name }} @endif</li>
                </ol>
            </div>
        </nav>
        <div class="container">
                    ...
                    <div class="table-resposive">
                        <table border="0" class="table custom-table mobileTable table-bordered table-sm w-100 bg-light text-dark" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="thirdMobile">{{ isset($price2) ? $country->currency : ''}} {{ isset($price2) ? $price2 :''}} </td>
                            </tr>
                            <tr>
