                ...
                <div class="container">
                    <div class="header-right py-1">
                        ...
                        <div class="social-icons py-2 py-xl-0">
                            <a target="_blank" class="social-icon social-facebook icon-facebook" href="https://www.facebook.com/mobilekisite/" title="Facebook"></a>
                            <a target="_blank" class="social-icon social-twitter icon-twitter" href="https://twitter.com/mobilekisite" title="Twitter"></a>
                            <a target="_blank" class="social-icon social-instagram icon-instagram" href="https://www.instagram.com/mobilekisite/" title="Instagram"></a>
                        </div>
                    </div><!-- End .header-right -->
                </div><!-- End .container -->
            </div><!-- End .header-top -->
            <div class="header-middle">
                <div class="container">
                    <div class="header-left py-0">
                        ...
                        <a href="{{URL::to('/')}}" class="">
                            <img src="{{URL::to('/')}}/images/logo.png" alt="mobile-ki-site-Logo" class="img-fluid my-2 mks-logo" width="150" height="60" />
                    ...
                    <div class="header-center flex-1 ml-0 justify-content-end justify-content-lg-start">
                        <div class="header-search header-search-inline header-search-category w-lg-max pr-2 pr-lg-0">
                            <a href="javascript:void(0);" title="search" class="search-toggle header-icon d-sm-inline-block d-lg-none mr-0" role="button"><i class="icon-search-3"></i></a>
                            <form action="{{route('search')}}" method="get">
                                <div class="header-search-wrapper">
                                    <input type="search" class="form-control" name="query" id="searchInput" placeholder="Search..."  required>
                    ...
                    <div class="header-right py-1">
                        @if(!Auth::check())
                            <a href="{{URL::to('/login')}}" class="header-icon"  data-toggle="modal" data-target="#loginModal"><i class="icon-user-2"></i></a>
                        @else
                                ...
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-products">
                                        ...
                                        <div class="product py-2">
                                            <div class="product-details">
                                                <h4 class="product-title font-weight-normal">
                                                    <a href="{{ route('logout') }}" class="header-icon" style="line-height: 1.6rem;height: 1.6rem;"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                </h4>
                                            </div><!-- End .product-details -->
                                        </div>
            ...
            <div class="header-bottom mb-lg-2 sticky-header" data-sticky-options="{
                ...
                <div class="container px-0">
                    <div class="logo logo-transition logo-white w-100 d-none">
                        <a href="{{URL::to('/')}}">
                            <img src="{{URL::to('/')}}/images/logo.png" alt="mobile-ki-site-Logo" class="img-fluid my-2" width="110" height="46"/>
                    ...
                    <div class="bg-dark w-100">
                        <nav class="main-nav">
                            <ul class="menu d-flex justify-content-center">
                                ...
                                <li><a href="{{route('ad.index')}}">Ads <span class="badge badge-danger">New</span></a></li>
                                <li><a href="{{route('package.index')}}">Packages <span class="badge badge-danger">New</span></a></li>
                    ...
                    <div class="row row-sm">
                        <div class="col-12 col-md-4 col-lg-5">
                            <div class="widget widget-about">
                                ...
                                <p class="mb-3">Mobile ki shop (MKS) is the best mobile website that provides the latest mobile phone prices in Pakistan with specifications, features, reviews and comparison.</p>
                            </div><!-- End .widget -->
                        ...
                        <div class="col-12 col-md-5 col-lg-5">
                            <div class="widget">
                                ...
                                <ul class="contact-info d-flex flex-wrap">
                                    <li>
                                        <span class="contact-info-label">Address:</span> Office: 115, Century Tower Kalma Chowk Gulberg 3 Lahore, Pakistan.
                                    </li>
                                    <li>
                                        <span class="contact-info-label">Phone:</span><a href="tel:+923111222741">03-111-222-741</a>
                                    </li>
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a href="mailto:info@mks.com.pk">info@mks.com.pk</a>
                                    </li>
                                    <li>
                                        <span class="contact-info-label">Working Days/Hours:</span>Mon - Fri / 9:00 AM - 6:00 PM
                                    </li>  
                                </ul>
                            </div><!-- End .widget -->    
                            <div class="social-icons">
                                <a href="https://www.facebook.com/mobilekisite/" class="social-icon social-facebook icon-facebook" target="_blank" title="Facebook"></a>
                                <a href="https://twitter.com/mobilekisite" class="social-icon social-twitter icon-twitter" target="_blank" title="Twitter"></a>
                                <a href="https://www.instagram.com/mobilekisite/" class="social-icon social-instagram icon-instagram" target="_blank" title="Instagram"></a>
                            </div>
                        </div><!-- End .widget -->
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li><a href="{{URL::to('/blog/')}}/">Blog</a></li>
                    <li><a href="{{route('ad.index')}}" class="font-weight-bold">Ads <span class="badge badge-danger">New</span></a></li>
                    <li><a href="{{URL::to('/contact')}}">Contact Us</a></li>
                </ul>
            </nav><!-- End .mobile-nav -->
          ...
          <div class="modal-body">
            ...
            <div class="col-md-6">
                ...
                <form action="#" method="post" id="loginForm">
                    ...
                    <input type="email" name="login_email" class="form-input form-wide mb-2" id="login-email" required />

                    <label for="login-password">Password <span class="required">*</span></label>
                    <input type="password" name="login_password" class="form-input form-wide mb-2" id="login-password" required />
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <a href="#" id="sign-with-facebook">
                                <img src="{{URL::to('/images/login-with-facebook.jpg')}}" alt="login-with-facebook" class="img-fluid">
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <form action="{{route('register')}}" method="post">
                    ...
                    <input type="text" name="name" class="form-input form-wide mb-2" id="register-name" required>

                    <label for="register-phone">Phone Number<span class="required">*</span></label>
                    <input type="text" name="phone_number" class="form-input form-wide mb-2" id="register-phone" required>
