            ...
            <div class="col-12 col-md-5 col-lg-5">
                <div class="widget">
                  ...
                  <ul class="contact-info list-unstyled">
                    ...
                    <li>
                        <a href="{{URL::to('/category/').'/'.$categori->slug}}" class="text-decoration-none">{{$categori->category_name}}</a>
                    </li>
                    @endforeach
                    @endif
                    @if(session('country_code') == 'pk')
                    <li>
                      <a href="{{URL::to('/packages')}}" class="text-decoration-none">Packages</a>
                    </li>  
                    @endif
                  </ul>
                </div>
              ...
              <div class="col-12 col-md-3 col-lg-2">
                <div class="widget">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a href="{{URL::to('/about-us')}}" class="text-decoration-none">About Us</a>
                    </li>  
                    <li>
                      <a href="{{URL::to('/privacy-policy')}}" class="text-decoration-none">Privacy Policy</a>
                    </li>
                    <li>
                      <a href="{{URL::to('/terms-and-conditions')}}" class="text-decoration-none">Terms and Conditions</a>
                    </li>
                    <li>
                      <a href="{{url('html-sitemap')}}" class="text-decoration-none">Sitemap</a>
                    </li>
                    <li>
                      <a href="{{URL::to('/contact')}}" class="text-decoration-none">Contact Us</a>
                    </li>
                  </ul>
                </div>
