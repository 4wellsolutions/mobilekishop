        ...
        <div class="widget-body">
            <ul class="list-unstyled ps-2">
                @foreach($categories as $categori)
                    <li>
                        <a href="{{route('category.show',$categori->slug)}}" class="{{ isset($category) ? ($category->slug == $categori->slug ? 'fw-bold' : '') : (Request::segment(2) == $categori->slug ? 'fw-bold' : '') }}">{{$categori->category_name}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
...
<div class="widget-sidebar p-2 m-2">
    <p class="widget-title fw-bold mb-1">
        <a data-toggle="collapse" href="#widget-body-1" role="button" aria-expanded="true" aria-controls="widget-body-1">Network</a>
    </p>
...
@if(isset($filters) && $filters->isNotEmpty())
    <div class="widget-sidebar p-2 m-2">
        <p class="widget-title fw-bold mb-1">
            <a data-toggle="collapse" href="#widget-body-4" role="button" aria-expanded="true" aria-controls="widget-body-4">Filters</a>
        </p>
            ...
            <div class="widget-body">
                <ul class="list-unstyled p-2">
                    @foreach($filters as $filter)
                        <li>
                            <a href="{{$filter->url}}" class="{{ str_contains(request()->url(), $filter->url) ? 'fw-bold' : '' }}">{{$filter->title}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
        ...
        <div class="widget-body">
            <ul class="list-unstyled p-2">
                @foreach($priceRanges as $priceLimit)
                    <li>
                        <a href="{{route('tablet.under.amount',$priceLimit)}}">Tablets Under {{number_format($priceLimit)}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
...
<div class="widget-sidebar p-2 m-2">
    <p class="widget-title fw-bold mb-1">
        <a data-toggle="collapse" href="#widget-body-4" role="button" aria-expanded="true" aria-controls="widget-body-4">RAM</a>
    </p>
    <div class="collapse show" id="widget-body-4">
        <div class="widget-body">
            <ul class="list-unstyled p-2">
...
<div class="widget-sidebar p-2 m-2">
    <p class="widget-title fw-bold mb-1">
        <a data-toggle="collapse" href="#widget-body-5" role="button" aria-expanded="true" aria-controls="widget-body-5">Storage</a>
    </p>
...
<div class="widget-sidebar p-2 m-2">
    <p class="widget-title fw-bold mb-1">
        <a data-toggle="collapse" href="#widget-body-6" role="button" aria-expanded="true" aria-controls="widget-body-6">Screen Size</a>
    </p>
...
<div class="widget-sidebar p-2 m-2">
    <p class="widget-title fw-bold mb-1">
        <a data-toggle="collapse" href="#widget-body-7" role="button" aria-expanded="false" aria-controls="widget-body-7">Camera</a>
    </p>
