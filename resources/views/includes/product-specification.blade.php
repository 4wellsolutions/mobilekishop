    ...
    <div class="col-12">
        ...
        <div class="product-desc-content mt-2">
            <div class="table-resposive">
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    cellpadding="0">
                    <tbody>
                        <tr class="">
                        ...
                        <tr class="">
                            <th>Brand</th>
                            <td colspan="2"><a
                                    href="{{ url(($country->country_code === 'pk' ? '' : $country->country_code) . '/brand/' . $product->brand->slug . '/' . $product->category->slug) }}"
                ...
                <table border="0" class="table custom-table  table-sm w-100 text-dark" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        @if($os)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/the-evolution-of-mobile-operating-systems/"
                                        class="text-dark">OS</a></th>
                                <td colspan="2">{{ $os }}</td>
                            </tr>
                        @endif
                        @if($ui)
                        ...
                        @if($dimensions)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/dimensions/" class="text-dark">Dimensions</a>
                                </th>
                        ...
                        @if($weight)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-weight/" class="text-dark">Weight</a>
                                </th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center text-danger bg-light fs-6"><a
                                    href="https://mobilekishop.net/blog/mobile-networks-1g-to-5g/"
                                    class="text-danger">NETWORK</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($technology)
                        ...
                        @if($g2_band)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/2g-mobile-network/" class="text-dark">2G Band</a>
                                </th>
                        ...
                        @if($g3_band)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/3g-mobile-network/" class="text-dark">3G Band</a>
                                </th>
                        ...
                        @if($g4_band)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/4g-mobile-network/" class="text-dark">4G Band</a>
                                </th>
                        ...
                        @if($g5_band)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/5g-mobile-network/" class="text-dark">5G Band</a>
                                </th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        @if($chipset)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-a-chipset/" class="text-dark">Chipset</a>
                                </th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center text-danger bg-light fs-6"><a
                                    href="https://mobilekishop.net/blog/mobile-display-technology/"
                                    class="text-danger">DISPLAY</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($display)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-display-type/" class="text-dark">Type</a>
                                </th>
                        ...
                        @if($size)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-display-size/" class="text-dark">Size</a>
                                </th>
                        ...
                        @if($resolution)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-resolution/"
                                        class="text-dark">Resolution</a></th>
                                <td colspan="2">{{ $resolution }}</td>
                            </tr>
                        @endif
                        @if($protection)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-screen-protection/"
                                        class="text-dark">Protection</a></th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center text-danger bg-light fs-6"><a
                                    href="https://mobilekishop.net/blog/what-is-rom/" class="text-danger">MEMORY</a>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center bg-light fs-6"><a
                                    href="https://mobilekishop.net/blog/what-is-a-camera/"
                                    class="text-danger">CAMERA</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($main)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-the-main-rear-camera/"
                                        class="text-dark">Main</a></th>
                        ...
                        @if($front)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-the-front-selfie-camera/"
                                        class="text-dark">Front</a></th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        @if($bluetooth)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-bluetooth/"
                                        class="text-dark">Bluetooth</a></th>
                        ...
                        @if($radio)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-a-radio/" class="text-dark">Radio</a>
                                </th>
                        ...
                        @if($infrared)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-is-infrared/" class="text-dark">Infrared</a>
                                </th>
                ...
                <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                    ...
                    <tbody>
                        @if($sensors)
                            <tr>
                                <th><a href="https://mobilekishop.net/blog/what-are-sensors/" class="text-dark">Sensors</a>
                                </th>
                ...
                @if($battery_new || $battery_old || $loudspeaker || $geekbench || $antutu)
                    <table border="0" class="table custom-table table-bordered table-sm w-100 text-dark" cellspacing="0"
                        ...
                        <tbody>
                            @if($battery_new)
                                <tr>
                                    <th><a href="https://mobilekishop.net/blog/what-is-a-battery/" class="text-dark">Battery</a>
                                    </th>
                            ...
                            @if($loudspeaker)
                                <tr>
                                    <th><a href="https://mobilekishop.net/blog/what-is-a-loudspeaker/"
                                            class="text-dark">Loudspeaker</a></th>
