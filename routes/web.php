...
// Country-specific routes under the dynamic country subdomain
Route::domain('{country_code}.mobilekishop.net')->group(function () {
    Route::middleware(['default.country'])->group(function () {
        ...
        // Smart watch route
        Route::get('/smart-watches-under-{amount}', [CountryController::class, 'underAmountWatches'])->name('country.watch.under')->where('country_code', '^(in|us|uk|bd|ae)$');
